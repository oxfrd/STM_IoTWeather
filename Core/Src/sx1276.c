...
void SX1276IoInit(void) {
    GpioInit(&SX1276.DIO0, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
    GpioInit(&SX1276.DIO1, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
    GpioInit(&SX1276.DIO2, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
    //GpioInit(&SX1276.DIO3, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
    //GpioInit(&SX1276.DIO4, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
    //GpioInit(&SX1276.DIO5, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
}
...
{
    GpioInit(&SX1276.DIO0, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
    GpioInit(&SX1276.DIO1, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
    GpioInit(&SX1276.DIO2, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
    //GpioInit(&SX1276.DIO3, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
    //GpioInit(&SX1276.DIO4, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
    //GpioInit(&SX1276.DIO5, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
}
...
{
    GpioInit(&(SX1276.AntSwitchLf), PIN_OUTPUT, PIN_PUSH_PULL, PIN_PULL_UP, 1);
    GpioInit(&(SX1276.AntSwitchHf), PIN_OUTPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0);
}

void SX1276AntSwDeInit(void)
{
    GpioInit(&(SX1276.AntSwitchLf), PIN_OUTPUT, PIN_OPEN_DRAIN, PIN_NO_PULL, 0);
    GpioInit(&(SX1276.AntSwitchHf), PIN_OUTPUT, PIN_OPEN_DRAIN, PIN_NO_PULL, 0);
}
...
void SX1276SetAntSw(uint8_t rxTx)
{
    ...
    if(rxTx != 0) {// 1: TX, 0: RX
        GpioWrite(&(SX1276.AntSwitchLf), 0);
        GpioWrite(&(SX1276.AntSwitchHf), 1);
    } else {
        GpioWrite(&(SX1276.AntSwitchLf), 1);
        GpioWrite(&(SX1276.AntSwitchHf), 0);
    }
}
